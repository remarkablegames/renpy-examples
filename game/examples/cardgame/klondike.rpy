...
init python:
    ...
    class Klondike(object):
        ...
        def __init__(self, deal=3):
            ...
            self.table = t = Table(base="images/cardgame/card/base.png", back="images/cardgame/card/back.png")
            ...
            for rank in range(1, 14):
                for suit in range(0, 4):
                    value = (suit, rank)
                    t.card(value, "images/cardgame/card/%d.png" % self.card_num(suit, rank))
